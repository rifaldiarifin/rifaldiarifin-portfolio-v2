...
const TestPage = () => {
  ...
  return (
    <>
      ...
      <div className="codes">
        <div className="write-code" data-numberline="3"></div>
      </div>
      <div className="codes">
      ...
      <div className="codes" ref={homeRef}>
        <div className="write-code" data-numberline="6">
          ...
          {cihuyReactRender.home && (
            <span className="rendercode-notif">Rendered time: {componentRenderData[0].renderTime}ms</span>
          )}
        </div>
        <div className="display-frame wait">
          {cihuyReactRender.home ? (
            <div className="render testpage">
              <h1>Hello World</h1>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem maxime nihil incidunt eaque
                tempora, debitis, id dolore voluptatum dolorem explicabo sit, totam cumque nulla deserunt earum tempore
                iusto quaerat sed?
              </p>
